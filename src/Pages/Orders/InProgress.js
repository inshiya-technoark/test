              ...
              <nav className="sidebar card">
                <ul className="nav flex-column" id="nav_accordion">
                  ...
                  <li className="nav-item has-submenu active">
                    <a onClick={toggling} className="nav-link"><Link to='/order'> Orders</Link>  <i id= "downarrow" className="fas fa-chevron-down" /></a>
                ...
                <div className="col-md-12">						
                  <nav>
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                      <a className="nav-item active" id="nav-activeOrders-tab" data-toggle="tab" href="#nav-activeOrders" role="tab" aria-controls="nav-activeOrders" aria-selected="true">
                        In Progress Orders</a>
