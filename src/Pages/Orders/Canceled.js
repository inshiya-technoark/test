...
const options = [<Link to='/order'> Active Orders</Link> ,<Link to='/completedorder'>Completed Orders</Link>, <Link to='/returns'>Returns</Link>, <li className="nav-item nav-active">
              ...
              <nav className="sidebar card">
                <ul className="nav flex-column" id="nav_accordion">
                  ...
                  <li className="nav-item has-submenu">
                    <a onClick={toggling} className="nav-link"><Link to='/order'> Orders</Link> <i className="fas fa-chevron-down" onClick={toggling}/></a>
                    {isOpen && (
                ...
                <div className="col-md-12">           
                  <nav>
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                      <a className="nav-item active" id="nav-activeOrders-tab" data-toggle="tab" href="#nav-activeOrders" role="tab" aria-controls="nav-activeOrders" aria-selected="true">Canceled</a>
